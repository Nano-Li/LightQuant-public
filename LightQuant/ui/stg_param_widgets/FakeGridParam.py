# -*- coding: utf-8 -*-
# @Time : 2024/3/11 11:14
# @Author : 
# @File : FakeGridParam.py 
# @Software: PyCharm
...
class FakeGridParam(ParamWidget):
    """
    智能调仓网格参数
    """
    ...
    def get_input_params(self) -> dict:
        ...
        input_param_dict['up_price'] = float(69000)
        input_param_dict['leverage'] = int(20)
        ...
        input_param_dict['grid_rel_step'] = float(0.5)
        input_param_dict['filling_step'] = float(10)
        input_param_dict['lower_step'] = float(30)
        input_param_dict['filling_fund'] = float(1000)
