# -*- coding: utf-8 -*-
# @Time : 2024/2/12 18:35
# @Author : 
# @File : MarketMakerGridParam.py 
# @Software: PyCharm
import re
...
class MarketMakerGridParam(ParamWidget):
    """
    智能调仓网格参数
    """
    ...
    def get_input_params(self) -> dict:
        ...
        input_param_dict['up_price'] = 52000
        input_param_dict['leverage'] = 50
        input_param_dict['trigger_start'] = False
        input_param_dict['pending_trigger_price'] = ''
        # 对于比例间距、补仓价差和下方价差，如果输入为空，则保留空字符串，否则转换为float
        input_param_dict['grid_rel_step'] = 0.005
        input_param_dict['filling_step'] = 0.5
        input_param_dict['lower_step'] = 1
